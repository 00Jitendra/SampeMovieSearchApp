...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.sample.searchmovieapp.util.imageHelper.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.sample.searchmovieapp.util.imageHelper.GlideOptions().apply(toSet));
    }
  }
}
