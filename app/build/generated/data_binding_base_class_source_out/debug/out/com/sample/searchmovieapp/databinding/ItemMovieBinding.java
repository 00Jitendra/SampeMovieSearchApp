...
public abstract class ItemMovieBinding extends ViewDataBinding {
  @NonNull
  public final CardView imageMovieLl;

  @NonNull
  public final AppCompatImageView imgMov;

  @Bindable
  protected SearchMovies.Search mAllItem;

  @Bindable
  protected HomeViewModel mViewModel;

  protected ItemMovieBinding(Object _bindingComponent, View _root, int _localFieldCount,
      CardView imageMovieLl, AppCompatImageView imgMov) {
    super(_bindingComponent, _root, _localFieldCount);
    this.imageMovieLl = imageMovieLl;
    this.imgMov = imgMov;
  }

  public abstract void setAllItem(@Nullable SearchMovies.Search allItem);

  @Nullable
  public SearchMovies.Search getAllItem() {
    return mAllItem;
  }
